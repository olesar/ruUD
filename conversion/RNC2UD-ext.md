...
|-|adnum|Number=Count|счётная форма (_два часа́_, _три шара́_)|adnumeral form|
||brev|Variant=Short|краткая форма (_высок_, _нежна_, _прочны_, _рад_)|short form|
|-|plen|Variant=Long|полная форма (_высокий_, _нежная_, _прочные_, _морской_)|full form|
...
|-|comp2|Degree=Cmp2|форма «по+сравнительная степень» (_поглубже_)|second comparative degree (_po_ + comparative)|
...
|-|intr|Transit=Intr|непереходность (_ходить_, _вариться_)|intransitive verb|
|-|tran|Transit=Tran|переходность (_вести_, _варить_)|transitive verb|
...
|-|imper2|Mood=Imp2|форма повелительного наклонения 1 л. мн. ч. на -те (_идемте_)|second imperative (imperative on _-мте_)|
...
|-|persn|NounType=Persn|личное имя (_Иван_, _Дарья_, _Леопольд_, _Эстер_, _Гомер_, _Маугли_)|name of a person, first, given name|
|-|patrn|NounType=Patrn|отчество (_Иванович_, _Павловна_)|patronymic name|
|-|famn|NounType=Famn|фамилия (_Николаев_, _Волконская_, _Гумбольдт_)|family name, second name |
|-|zoon|NounType=Zoon|кличка животного (_Шарик_, _Дочка_)|zoonym|
|-|topon|NounType=Topon|топоним (_Москва_, _Полянка_)|toponym|
|-|0|Indecl=Yes|несклоняемое (_шоссе_, _Седых_)|indeclinable|
|-|anom|Anom=Yes|аномальная форма (различного рода морфологические аномалии, возможные у устаревших или просторечных нелитературных форм (_три дни_ при нормативном _три дня_, _ляжь_ при нормативном _ляг_))|grammatically anomalous form|
